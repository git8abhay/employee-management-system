...
const Footer = () => {
  return (
    <footer className="w-full mt-16 py-5 px-6 bg-white/5 backdrop-blur-md border-t border-cyan-400/20 text-cyan-100 text-sm flex flex-col sm:flex-row items-center justify-between">
