    ...
    <div className="flex-shrink-0 w-[300px] h-full p-5 bg-white/10 backdrop-blur-md rounded-xl border border-cyan-400/20 shadow-md hover:shadow-cyan-500/30 transition-all duration-300 text-white">
      ...
      <div className="flex justify-between items-center mt-6">
        ...
        <div className="flex gap-2">
          <button className="bg-green-600 hover:bg-green-500 px-2 py-1 text-xs rounded-full transition cursor-pointer">
            Completed
          </button>
          <button className="bg-red-600 hover:bg-red-500 px-2 py-1 text-xs rounded-full transition cursor-pointer">
            Failed
          </button>
        </div>
      </div>
